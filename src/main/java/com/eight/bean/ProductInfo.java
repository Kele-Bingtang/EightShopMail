...
public class ProductInfo {
	...
	// 有参构造器，进行属性值的初始化
	public ProductInfo(Long productId, String productCore, String productName, Integer oneCategoryId, Integer twoCategoryId, BigDecimal realPrice, BigDecimal price, Integer publishStatus, Timestamp productionDate, Integer shelfLife, String descript, Timestamp indate, Timestamp modifiedTime) {
